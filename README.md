...
- in your Shelly app, choose a month and export the consumption as csv-file
  <img src="https://github.com/Zheng-Bote/solaryield/Examples/shelly_plug_monthly_export.jpg" width="100%" height="auto" />
- copy your csv-file to your linux machine
- iwatch will automatically start the shellyield program
  <img src="https://github.com/Zheng-Bote/solaryield/Examples/iwatch.png"  width="100%" height="auto" />
- example output
